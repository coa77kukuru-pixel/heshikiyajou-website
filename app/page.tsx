          ...
          <div className="sched-list">
            ...
            <div className="sched-item reveal stagger-1">
              ...
              <div className="sched-body">
                ...
                <p>チケット情報について：<a href="https://www.nt-okinawa.or.jp/performance-info/detail?performance_id=2845" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'underline' }}>国立劇場おきなわHPよりご確認ください</a></p>
              </div>
              <div className="sched-venue">国立劇場おきなわ<small>National Theatre Okinawa</small></div>
              <div className="sched-status confirmed">出演決定</div>
            </div>
      ...
      <section className="profile" id="profile">
        ...
        <div className="profile-body">
          ...
          <div className="profile-text reveal-right">
            <p>平敷屋門 勇也（へしきやじょう ゆうや）、1989年、沖縄県うるま市勝連平敷屋（平敷屋門 門中）の生まれ。物心ついた頃には「沖縄の芸能をやりたい」と自ら口にし、4歳の誕生日の翌週、初めて稽古場の扉を叩いた。</p>
            <p>玉城流光乃会・赤嶺啓子の門下で琉球舞踊を学び、小・中・高と現代版組踊「肝高の阿麻和利」へ出演。1度は芸事を離れる時期もあったが、21歳で沖縄へ戻り、再び舞踊と向き合う。創作舞踊集団「結華」を設立、会長を務める。28歳で唄三線・古典音楽・舞踊の3者によるユニット「チャンプ流ぅ芸能団」を結成。</p>
      ...
      <section className="champru sec-dark" id="champru">
        ...
        <div className="champ-grid">
          ...
          <div className="champ-text reveal-right">
            ...
            <p>伝統を背負う若手芸能家が、即興コント・歌・踊りを一舞台に編む。子どもから大人まで、笑いの絶えない唯一無二の場をつくり続けている。最年少ながら、リーダーとして全体を律する勇也の姿がある。</p>
